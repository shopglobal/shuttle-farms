...
contract ShuttleToken is Context, ERC20, Ownable {
    ...
    // Address that include in shuttle LP list
    mapping(address => bool) private _includeInShuttleLpList;
    ...
    // Minimum SHUTTLE sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInShuttleLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInShuttleLpList(address _address) public view returns (bool) {
        return _includeInShuttleLpList[_address];
    }

    function setIncludeInShuttleLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInShuttleLpList[_address] = _isIncludedOrNot;
    }
    ...
    function _transfer(
        ...
        && !isIncludedInShuttleLpList(from)
        && from != owner()
        ) {
            ...
            if (isIncludedInShuttleLpList(to)) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 shuttle");
